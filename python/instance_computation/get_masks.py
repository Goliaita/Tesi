...
parser.add_argument("--output", default="runs/detect/exp16/instances", help="Path where save the image masks")

parser.add_argument("--config_file", default="../AdelaiDet/configs/BlendMask/R_101_dcni3_5x.yaml")
parser.add_argument("--train_json_path", default="runs/detect/exp16/instances/labels.json")
parser.add_argument("--train_path", default="runs/detect/exp16/cropped")
parser.add_argument("--val_json_path", default="runs/detect/exp16/instances/labels.json")
parser.add_argument("--val_path", default="runs/detect/exp16/cropped")
