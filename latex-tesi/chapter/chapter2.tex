...
pixel-level segmentation masks of plants and leaves, respectively, that were manually annotated by experts. The annotation consisted of three steps. First, we obtained
a binary segmentation of plant objects in the scene in a computer-assisted manner. For Arabidopsis, we used the active contour-based approach described by Minervini et al.
...
to ensure that all visible part of the shoot is included in the plant mask and the background is excluded. Next, within the binary mask of each plant, we outlined the
...
\item In classification and regression For mutant and treatment recognition we release individual plant images and a text list denoting for each line image name,
