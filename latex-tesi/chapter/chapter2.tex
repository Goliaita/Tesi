...
of shape priors, which can be further used to segment individual leaves into overlapping regions in the image.\cite{9411981}
...
better results than SegNet and comparable results to U-Net.\cite{KOLHAR2021101373}


\section{Automatic segmentation combining Mask RCNN}
...
the proposed method could facilitate the study of 3-D lead phenotype search and improve the accuracy of automatic leaf segmentation.\cite{LIU2020105753}
