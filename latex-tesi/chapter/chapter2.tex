...
platform. For this reason, we provided the original depth image and a transformation matrix from the depth image viewpoint to the RGB image
...
field map and leaf tips of the polar transformed image. For leaf tip detection, we chose the Harris-Stephens angle detector. The second approach was
